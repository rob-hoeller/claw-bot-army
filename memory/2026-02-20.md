...
### Root Cause
The send route was re-fetching files from Supabase URLs to convert to base64 — an unnecessary round-trip that could timeout on Vercel's function limit. Errors were silently swallowed.
